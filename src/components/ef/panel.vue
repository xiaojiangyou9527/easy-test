<template>
    <div v-if="easyFlowVisible" style="height: calc(100vh);">
        ...
        <div style="display: flex;height: calc(100% - 47px);">
            ...
            <div class="hx-ef-container flex">
                ...
                <div class="hx-ef-foot flex">
                    <el-button type="text" icon="el-icon-delete" size="large" @click="deleteElement" :disabled="!this.activeElement.type">删除节点</el-button>
                    <div>
                        <el-button type="primary" @click="syncState">同步</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            jsPlumbInit() {
                this.jsPlumb.ready(() => {
                    ...
                    this.jsPlumb.bind('click', (conn, originalEvent) => {
                        console.log('originalEvent', conn, originalEvent)
            ...
            setLineLabel(from, to, label) {
                console.log('setLineLabel', from, to, label)
